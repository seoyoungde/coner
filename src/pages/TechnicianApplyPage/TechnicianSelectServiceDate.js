...
const TechnicianSelectServiceDate = () => {
  ...
  const selectedTechnician =
    location.state?.selectedTechnician || requestData.selectedTechnician;
  ...
  const handleNext = () => {
    ...
    navigate(`/technician-requestbasicinfo/${selectedTechnician.id}`, {
      state: {
        selectedDate,
        selectedTime,
      },
    ...
    >
      <Container ref={ref}>
        <Header>
          <BackButton
            onClick={() =>
              navigate(`/technician-address/${selectedTechnician.id}`)
            }
          >
            <BackIcon>
...
export default TechnicianSelectServiceDate;
